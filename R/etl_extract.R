...
etl_extract.etl_idswb <- function(obj, years = lubridate::year(Sys.Date()),
  ...
  valid_months <- mutate(valid_months, lcl = paste0(dir, "/idswb_", valid_months$year, "_", valid_months$month, ".csv"))
